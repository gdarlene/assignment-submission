...
export default function  ClassB(){
    ...
    const data=[
        ...
        },
        {
            ...
            Description:"A scientist is studying the growth rate of a bacteria colony over time. The number of bacteria at time tt (in hours) is given by the function...", 
    ...
    return (
            ...
            <div className="flex items-center gap-[2rem]">
                ...
                <div className="flex  flex-col gap-[1rem] ">
                    ...
                    <div className="w-[673px] overflow-hidden text-ellipsis line-clamp-2">{item.Description}</div>
